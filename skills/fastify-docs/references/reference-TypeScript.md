...
To validate your requests and responses you can use JSON Schema files. If you didn't know already, defining schemas for your Fastify routes can increase their throughput! Check out the [Validation and Serialization](reference-Validation-and-Serialization.md) documentation for more info.
...
They simplify schema validation setup and you can read more about them in [Type Providers](reference-Type-Providers.md) page.
...
For more details on using HTTP2 check out the Fastify [HTTP2](reference-HTTP2.md) documentation page.
...
An interface definition for the internal Fastify logger. It is emulative of the [Pino.js](https://getpino.io/#/) logger. When enabled through server options, use it following the general [logger](reference-Logging.md) documentation.
