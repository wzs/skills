...
* API Gateway does not support streams yet, so you are not able to handle [streams](reference-Reply.md#streams).
...
[Fluid compute](https://vercel.com/docs/functions/fluid-compute) currently requires an explicit opt-in. Learn more about enabling Fluid compute [here](https://vercel.com/docs/functions/fluid-compute#how-to-enable-fluid-compute).
