...
* The [reply serializer](reference-Server.md#setreplyserializer) if set
* The [serializer compiler](reference-Server.md#setserializercompiler) if a JSON schema is set for the HTTP status code
