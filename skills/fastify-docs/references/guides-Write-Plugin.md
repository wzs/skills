...
Fastify uses different techniques to optimize its code, many of which are documented in our Guides. We highly recommend you read [the hitchhiker's guide to plugins](guides-Plugins-Guide.md) to discover all the APIs you can use to build your plugin and learn how to use them.
...
Once you submit a plugin to our [ecosystem list](guides-Ecosystem.md), we will review your code and help you improve it if necessary.
